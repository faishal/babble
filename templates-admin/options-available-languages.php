...
<p><?php esc_html_e( 'Please select the languages you wish to translate this site into. You should select at least two, and select "Save Changes" below the languages table.', 'babble' ); ?></p>
		...
		<tr id="language-<?php echo esc_attr( $lang->code ); ?>">
			...
			<td class="manage-column column-text_direction">
				<?php if ( 'ltr' == $lang->text_direction ) : ?>
					<?php esc_html_e( 'Left to right', 'babble' ); ?>
				<?php else : ?>
					<?php esc_html_e( 'Right to left', 'babble' ); ?>
				<?php endif; ?>
			</td>
		</tr>
		<?php endforeach; ?>
